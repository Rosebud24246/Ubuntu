...
Optimize for loading speed and performance with a standalone 5KB JavaScript file.
...
Works for block editor and classic editor(via shortcode).
...
2. Slider result
3. Slider gradient editor screenshot
4. Slider result