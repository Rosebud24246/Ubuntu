...
**[Demos](https://bblockswp.com/demo/button/)**
...
- **Size**: Make button small, medium, large, extra large also full width.
...
- Add the Button Block from the block category called "Widgets" in Gutenberg editor.
