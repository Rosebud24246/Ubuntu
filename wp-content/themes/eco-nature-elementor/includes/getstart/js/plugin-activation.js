jQuery(document).ready(function($) {
    'use strict';
    var this_obj = eco_nature_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.eco-nature-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message eco-nature-elementor-plugin-install');
                button.addClass('button-primary eco-nature-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.eco-nature-elementor-recommended-plugins .eco-nature-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.eco-nature-elementor-plugin-activate', function(event) {
