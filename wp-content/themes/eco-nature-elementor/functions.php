...
if (!function_exists('eco_nature_elementor_loop_columns')) {
	function eco_nature_elementor_loop_columns() {
		return get_theme_mod( 'eco_nature_elementor_products_per_row', '3' ); 
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'eco_nature_elementor_products_per_page' );
function eco_nature_elementor_products_per_page( $cols ) {
  	return  get_theme_mod( 'eco_nature_elementor_products_per_page',9);
}
...
define('ECO_NATURE_ELEMENTOR_FREE_THEME_DOC',__('https://www.wpelemento.com/theme-documentation/eco-nature-elementor/','eco-nature-elementor'));
